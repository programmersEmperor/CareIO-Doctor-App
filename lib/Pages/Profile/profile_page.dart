  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: controller.refreshDoctorUserData,
                      ...
                      children: [
                        ...
                        Stack(
                          children: [
                            ...
                            if (controller.doctorUser.value.avatar == null || controller.doctorUser.value.avatar!.isEmpty) ...[
                              Align(
                        ...
                        Text(
                          controller.doctorUser.value.name??"",
                        ...
                        Center(
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                controller.doctorUser.value.phone ?? "",
                                style: TextStyle(
                                  color: Colors.black38,
                                  fontSize: 10.sp,
                                ),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              controller.doctorUser.value.rating == null
                                                  ? "0.0"
                                                  : controller.doctorUser.value.rating!.toStringAsFixed(1),
                                              style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 20.sp,
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              controller.doctorUser.value.completedAppointments == null ? "0" : controller.doctorUser.value.completedAppointments.toString(),
                                              style: TextStyle(
                                                  color: AppColors.primaryColor,
                                                  fontSize: 20.sp,
                                                  fontWeight: FontWeight.bold),
                        ...
                        ProfileItem(
                            ...
                            onTap: () => controller.showEditProfileBottomSheet()
                        ),
                        SizedBox(
                          height: 13.sp,
                        ),
